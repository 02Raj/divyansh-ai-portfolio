...
const STATIC = {
  ...
  projects:
    "Absolutely! A few projects I'm proud of:\n\n1. SlantPOS — Point of Sale (Nov 2022 – Present)\n   • Tech Stack: Angular, Spring Boot, PostgreSQL, MongoDB, WebSocket\n   • Metrics: 15+ modules · WebSocket KDS · 2+ years in production\n\n2. CiteMind — Grounded document Q&A (Sep 2026)\n   • Stack: Spring Boot, Angular, pgvector, JWT, Spring AI, Gemini, SSE\n   • RAG with citations; insufficient_context when no relevant chunks · github.com/02Raj/citemind-\n\n3. TechPlusNexus — AI Blog (Apr–May 2025) · live techplusnexus.fun\n\n4. Razorpay Clone Backend (2025) · Spring Boot, PostgreSQL, JPA · github.com/02Raj/razorpay-clone-backend\n\n5. TutorPe — tutorpe.in · Next.js, Firebase",
  experience:
