...
export const STATIC_QUICK_REPLIES = {
  about: `Hey there! I'm Divyansh Raj, a Java Full-Stack Developer based in Noida. With 3+ years at SlantCo, I build scalable apps with Spring Boot, Java, REST APIs, and Angular.
